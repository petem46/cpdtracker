...
class MyCPDCourseDetailsResource extends JsonResource
{
  public function toArray($request)
  {
    ...
    return [
      ...
      'myratingid'       => CourseRating::where('course_id', $this->id)->where('user_id', $this->uid)->max('id'),
      'myprogressid'      => CourseProgress::where('user_id', $this->uid)->where('course_id', $this->id)->max('id'),
      ...
      'myreviewid'        => CourseReview::where('user_id', $this->uid)->where('course_id', $this->id)->max('id'),
